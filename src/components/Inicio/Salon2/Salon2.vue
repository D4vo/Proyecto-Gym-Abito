...
@media (max-width: 900px) {
  ...
  .clases-container { gap: 40px; } 
  .section-spacing { padding: 60px 0 !important; }
}
/* Aseguramos que la sección sea transparente para ver el pattern-bg del padre */
...
.btn-consultar:hover { background: #e50914; box-shadow: 0 0 20px rgba(229, 9, 20, 0.4); transform: translateY(-3px); }
